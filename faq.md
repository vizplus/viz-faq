...
Чем больше энергии вы потратите при награждении, тем больше получится размер награды. Процент использования энергии при награде обычно можно задать в приложении, которым вы пользуетесь, но в некоторых случаях приложение само определяет, каков должен быть процент. Поэтому лучше заранее изучить этот вопрос в приложении, чтобы не потратить слишком много энергии. При награждении через [Личный кабинет](https://my.viz.plus), вы сами выбираете процент награды.
